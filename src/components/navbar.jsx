        ...
        <header className="fixed top-0 left-0 w-full bg-rose-600 px-4 lg:px-6 py-2.5 z-50">
            <nav className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div className="flex items-center lg:order-2">
                    <a href="https://luanrodrigues.site" target="_blank" className="cursor-default text-rose-100 font-medium rounded-lg hover:underline text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2">@Luan Rodrigues</a>
                </div>
